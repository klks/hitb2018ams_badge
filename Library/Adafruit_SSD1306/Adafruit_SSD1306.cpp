...
void Adafruit_SSD1306::begin(uint8_t vccstate, uint8_t i2caddr, bool reset) {
  ...
  ssd1306_command(0x40);//--set start line address	Set Mapping RAM Display Start Line (0x00~0x3F)
  ssd1306_command(0x81);//--set contrast control register
  ssd1306_command(0xCF); // Set SEG Output Current Brightness
  ...
  ssd1306_command(0xD3);//-set display offset Shift Mapping RAM Counter (0x00~0x3F)
  ssd1306_command(0x00);//-not offset
  ssd1306_command(0xd5);//--set display clock divide ratio/oscillator frequency
  ssd1306_command(0x80);//--set divide ratio, Set Clock as 100 Frames/Sec
  ssd1306_command(0xD9);//--set pre-charge period
  ssd1306_command(0xF1);//Set Pre-Charge as 15 Clocks & Discharge as 1 Clock
  ssd1306_command(0xDA);//--set com pins hardware configuration
  ssd1306_command(0x12);
  ssd1306_command(0xDB);//--set vcomh
  ssd1306_command(0x40);//Set VCOM Deselect Level
  ssd1306_command(0x20);//-Set Page Addressing Mode (0x00/0x01/0x02)
  ssd1306_command(0x02);//
  ssd1306_command(0x8D);//--set Charge Pump enable/disable
  ssd1306_command(0x14);//--set(0x10) disable
  ssd1306_command(0xA4);// Disable Entire Display On (0xa4/0xa5)
  ssd1306_command(0xA6);// Disable Inverse Display On (0xa6/a7) 
